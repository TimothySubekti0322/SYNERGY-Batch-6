...
const EditCar = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setCost(data.cost);
        setSize(data.size);
        setFileName(trimFileName(data.imageUrl));
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      window.location.href = "/cars?message=Data%20Berhasil%20Diupdate";
    } catch (error) {
      console.log(error);
    } finally {
      setLoading(false);
              ...
              <div className="w-full">
                ...
                <div role="presentation" className="mt-6">
                  ...
                  >
                    ...
                    <p className="text-black">Edit Car</p>
                  </Breadcrumbs>
                </div>

                {/* <!-- Title , message, and Button --> */}
                <div className="w-full flex justify-between items-center mt-6">
                  <p className="text-2xl font-bold">Edit Car</p>
